...
export const ResumeAccess: React.FC<ResumeAccessProps> = ({
  heading,
  supportingCopy,
  formatBadge,
  downloadUrl,
  ...
  const isPersian = /[\u0600-\u06FF]/.test(heading);
  ...
  return (
    <div className="rounded bg-canvas-950/80 border border-border-subtle p-5 sm:p-6 flex flex-col justify-between relative group hover:border-border-panel transition-colors">
      <div>
        ...
        <div className="flex items-center justify-between gap-3 mb-3">
          <div className="flex items-center gap-2">
            <FileText className="w-4 h-4 text-accent-cyan shrink-0" aria-hidden="true" />
            <h3
      ...
      <div>
        ...
        >
          <Download className="w-4 h-4 text-accent-cyan shrink-0" aria-hidden="true" />
